...
{{< project-section img="table.png" alt="Carpe Noctem Table" rev="true" cap="Key Design parameters" >}}
...
{{< project-section img="sailplan.png" alt="Carpe Noctem Sailplan" rev="false" cap="Sail plan of the Carpe Noctem" >}}
...
{{< project-section img="cockpit.png" alt="Render of the Carpe Noctem's cockpit" cap="Render of the cockpit" rev="true" >}}
...
{{< project-image src="interior.png" alt="Sailboat interior arrangement" >}}
